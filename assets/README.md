...
| `assets/ships/`     | `boat_sheet.png`, optional `boat_sheet_<spieler>.png`, `ship_stage1_sheet.png`, `ship_sheet.png`, optional `ship_sheet_<spieler>.png` (+ Einzelbild-Fallbacks) | Wasserstraßen-Boot mit Bootsfahrer, Schiffbau-Gerippe, fertiges See-Schiff (je 4×6) | Zelle ~64×64 / ~96×96 |
...
| **Schiffe** | `assets/ships/boat_sheet.png`, `ship_sheet.png` | `assets/ships/boat_sheet_1.png`, `ship_sheet_1.png`, … |
...
- Aktueller Stand: `flag.png`/`flag_0.png` bis `flag_5.png` sind vorhanden.
  ...
  entschieden ist. Für Schiffe sind aktuell `assets/ships/boat_sheet_1.png` und
  `assets/ships/ship_sheet_1.png` als rote Gegnervarianten vorhanden; der
  Land-Anmarsch des Wasserträgers nutzt `assets/units/boat_carrier_1.png`.
